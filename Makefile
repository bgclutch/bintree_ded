...
SOURCES = main.cpp bintree.cpp dump.cpp akinator.cpp treeRW.cpp callgame.cpp ../stack_ded/stack_cpps/stack.cpp ../lib_file_proc/file.cpp ../lib_buffer_proc/buffer.cpp
...
bintree_o/%.o: src/bintree_cpps/%.cpp
	@$(CC) $(CFLAGS) $< -o $@
